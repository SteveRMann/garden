#define sketchName "garden.ino, V2.1"

/*
   Forked from GardenProject
   Removed sleep.
   V2.1 5/4/21 Changed period to 5 minutes
...
#ifndef Kaywinnet
#include "C:\Users\steve\Documents\Arduino\libraries\Kaywinnet\Kaywinnet.h"  // WiFi credentials
#endif
...
int sleepSeconds = 300;               //Seconds between readings
const int pubsubDelay = 20;           //ms between publishes
